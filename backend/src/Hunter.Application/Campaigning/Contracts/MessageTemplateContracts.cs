...
public record MessageTemplateDto(int Id, string Name, string Content, MessagingChannel Channel, int Version, bool IsActive, bool IsCatalogTemplate, bool IsFollowUpTemplate);
